...
RIF_USD_TBMA = CoinPair(RIF, USD, "TBMA", "Passing through Tether & Bitcoin, using [WDAP](fudamentals/wdap.md)")
RIF_USD_TMA = CoinPair(RIF, USD, "TMA", "Passing through Tether, using [WDAP](fudamentals/wdap.md)")
RIF_USD_WMTB = CoinPair(RIF, USD, "WMTB", "Passing through Tether & Bitcoin usinng weighted_median")

# RIF/USDT
RIF_USDT = CoinPair(RIF, USDT)
RIF_USDT_MA = CoinPair(RIF, USDT, "MA", "Using [WDAP](fudamentals/wdap.md)")
